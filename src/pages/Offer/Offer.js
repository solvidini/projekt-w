  ...
  return (
    <section className='section-offer'>
      ...
      <div className='offers'>
        <OfferItem source={images[0].src} alt={context.dictionary.offer.functional} name={images[0].title} />
        <OfferItem source={images[1].src} alt={context.dictionary.offer.conceptual} name={images[1].title} />
        <OfferItem source={images[2].src} alt={context.dictionary.offer.comprehensive} name={images[2].title} />
      </div>
    </section>
  );
};
