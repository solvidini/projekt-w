  ...
  return (
    <ul className='navigation-list'>
      ...
      <li className='navigation-item navigation-item--dropdown'>
        ...
        <div className='navigation-item navigation-item--dropdown__content' style={dropdownContentStyles}>
      ...
      <li className='navigation-item navigation-item--dropdown'>
        ...
        <div className='navigation-item navigation-item--dropdown__content' style={dropdownContentStyles}>
          ...
          <NavigationItem link='/realisations-premium'>{context.dictionary.nav.realisationsPremium}</NavigationItem>
        </div>
      </li>
      <li className='navigation-item' onClick={clicked}>
