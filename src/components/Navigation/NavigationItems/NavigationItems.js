...
const NavigationItems = (props) => {
  ...
  return (
    <ul className="navigation-list">
      ...
      <li className="navigation-item" onClick={props.clicked}>
        <NavigationItem link="/studio">
          {context.dictionary.nav.studio}
        </NavigationItem>
      </li>
      <li className="navigation-item navigation-item--dropdown">
        ...
        <div className="navigation-item navigation-item--dropdown__content">
      ...
      <li className="navigation-item" onClick={props.clicked}>
        <NavigationItem link="/offer">
          {context.dictionary.nav.offer}
        </NavigationItem>
      </li>
      <li className="navigation-item" onClick={props.clicked}>
        <NavigationItem link="/partners">
          {context.dictionary.nav.partners}
        </NavigationItem>
      </li>
      <li className="navigation-item" onClick={props.clicked}>
      ...
      <li
        className="navigation-item mobile-only"
